package com.herryuser1.gmall.realtime.app.dwd.log;
...
public class BaseLogApp {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> kafakaDs = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer(topic, groupId));

        // TODO 4. 数据清洗，转换结构
        // 4.1 定义错误侧输出流
        OutputTag<String> dirtyTag = new OutputTag<String>("dirtyStream") {
        };
        SingleOutputStreamOperator<String> cleanedStream = kafakaDs.process(
